...
try:
    MJ_INVITATION_TEMPLATE_ID = int(os.environ.get('MJ_INVITATION_TEMPLATE_ID'))
    MJ_EMAIL_CONFIRMATION_TEMPLATE_ID = int(os.environ.get('MJ_EMAIL_CONFIRMATION_TEMPLATE_ID'))
except TypeError:
    MJ_INVITATION_TEMPLATE_ID = ''
    MJ_EMAIL_CONFIRMATION_TEMPLATE_ID = ''
